...
class Graph extends Component<IProps, {}> {
  ...
  componentDidMount() {
    ...
    const element = document.getElementsByTagName('perspective-viewer')[0] as PerspectiveViewerElement;
    ...
    if (this.table) {
      ...
      // Add Perspective configurations here
      ...
      element.setAttribute('aggregates', JSON.stringify({
